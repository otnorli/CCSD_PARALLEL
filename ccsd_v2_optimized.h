#ifndef CCSD_V2_OPTIMIZED_H
#define CCSD_V2_OPTIMIZED_H
...
class ccsd_v2_optimized
{
public:
    ccsd_v2_optimized(int n_N, vec zz, mat rr, string B_s, int n_Elec);
